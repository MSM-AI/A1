...
public class UtilStr {
	...
	public static String getParentMsmCode(String code) {
		return code == null || code.isEmpty() ? null : code.substring(0, code.length() - 1);
	}
	...
	public static String[] justSplit(String str) {
		return str == null || str.isEmpty() ? null : str.split(SPACE);
	}

	public static String insInString(String str, String a, String b) {
		return str == null || str.isEmpty() ? null
				: a == null || b == null || b.isEmpty() || a.isEmpty() ? str : str.replaceAll(a, b);
	}
	...
	public static int truePercent(String a, String b) {
		return a == null || b == null || b.isEmpty() || a.isEmpty() ? MIN_TRUE
				: a.equals(b) ? MAX_TRUE : Math.floorDiv(MAX_TRUE, Math.max(a.length(), b.length())) * trueEnds(a, b);
	}
}
